...
% === === === Left
\draw[very thin] (0,0) -- ++({-(\asp-1)/2*3},3*\dep) -- ++(0,3);
\draw[very thin] (0,0) ++({-(\asp-1)/2*1},1*\dep) -- ++(0,3);
\draw[very thin] (0,0) ++({-(\asp-1)/2*2},2*\dep) -- ++(0,3);
\draw[very thin] (0,1) -- ++({-(\asp-1)/2*3},3*\dep);
\draw[very thin] (0,2) -- ++({-(\asp-1)/2*3},3*\dep);
% === === === Right
\draw[very thin] (3,0) -- ++({+(\asp-1)/2*3},3*\dep) -- ++(0,3);
\draw[very thin] (3,0) ++({+(\asp-1)/2*1},1*\dep) -- ++(0,3);
\draw[very thin] (3,0) ++({+(\asp-1)/2*2},2*\dep) -- ++(0,3);
\draw[very thin] (3,1) -- ++({+(\asp-1)/2*3},3*\dep);
\draw[very thin] (3,2) -- ++({+(\asp-1)/2*3},3*\dep);
\end{tikzpicture}
\end{document}
